...
class TestGeosynopticTango(unittest.TestCase):
    def setUp(self):
        self.g = GeosynopticTango()


class TestGetDeviceList(TestGeosynopticTango):
...
class TestGetDeviceProperties(TestGeosynopticTango):
